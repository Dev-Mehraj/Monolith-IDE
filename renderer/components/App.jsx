...
export default class App extends React.Component {
   ...
   */
  setFileTree(dirPath) {
    if (!fs.existsSync(path.join(dirPath, '/monolith.js'))) {
      exec(`npm i -S monolith-config && echo 'const yes = require("'monolith-config'") \n yes.config()' >> monolith.js && node monolith.js `,{
        cwd: dirPath
      });  
    }
